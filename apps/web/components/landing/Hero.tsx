      ...
      <div className="container mx-auto max-w-[1200px] px-4 text-center relative">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl md:text-2xl text-slate-400 mb-12 leading-relaxed max-w-3xl mx-auto">
            Orchestrate AI agents, tools, and APIs with a drag-and-connect editor. No code
            required—just connect, configure, and deploy.
          </p>
              ...
              <DialogContent className="max-w-4xl bg-slate-950 border-white/10">
                ...
                <div className="mt-4">
                  ...
                  <div className="mt-4 text-sm text-slate-400">
                    ...
                    GPT-4 processing → parallel tool execution → conditional branching → output
                    delivery.
                  </div>
                </div>
              </DialogContent>
