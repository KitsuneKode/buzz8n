  ...
  const faqs: FAQ[] = [
    {
      ...
      answer:
        'Our AI uses advanced natural language processing and machine learning models trained on thousands of workflow patterns. It analyzes your description, identifies key entities, relationships, and requirements, then maps them to optimal workflow architectures. The AI continuously learns from successful implementations to improve suggestions.',
      category: 'ai',
    ...
    },
    {
      ...
      answer:
        'Our AI achieves 95% accuracy in workflow generation, with most workflows requiring minimal manual adjustments. The AI validates connections, checks data compatibility, and predicts potential issues before deployment. It also provides confidence scores for each suggestion.',
      category: 'ai',
    ...
    },
    {
      ...
      answer:
        'Yes! Our AI continuously monitors workflow performance and suggests optimizations in real-time. It can identify bottlenecks, recommend parallel processing opportunities, suggest better tool alternatives, and automatically adjust resource allocation based on usage patterns.',
      category: 'ai',
    ...
    },
    {
      ...
      answer:
        'Our AI specializes in bridging modern and legacy systems by automatically generating appropriate adapters, handling data format conversions, and managing authentication protocols. It can work with REST APIs, SOAP services, databases, file systems, and custom protocols.',
    ...
    },
    {
      ...
      answer:
        'Our AI implements predictive error handling with automatic retry logic, fallback mechanisms, and intelligent error recovery. It learns from failures to prevent similar issues and provides detailed diagnostics with suggested fixes.',
      category: 'technical',
    ...
    },
    {
      ...
      answer:
        'Absolutely! The AI creates organization-specific models that learn from your workflow patterns, preferences, and successful implementations. This personalized intelligence improves suggestions and reduces setup time for similar workflows.',
      category: 'ai',
    ...
    },
    {
      ...
      answer:
        'AI operations include workflow generation, optimization suggestions, error predictions, and performance analysis. Each plan includes generous AI credits, and usage is transparently tracked in your dashboard with detailed breakdowns.',
      category: 'pricing',
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
            Get answers about our AI-powered workflow intelligence. Questions expand to show related
                    ...
                    {openFAQ === faq.id && (
                      ...
                      >
                        <div className="pt-4 border-t border-border/50 mt-4">
                          <p className="text-muted-foreground leading-relaxed mb-6">{faq.answer}</p>
          ...
          <Card className="bg-primary/5 border-primary/20 max-w-2xl mx-auto">
            <CardContent className="p-8">
              ...
              <p className="text-muted-foreground mb-6">
                Our AI experts are here to help you understand how intelligent workflows can
