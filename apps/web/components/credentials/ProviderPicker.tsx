...
import { Provider } from './CredentialModal'
    ...
    <div className="p-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-h-96 overflow-y-auto">
        {filteredProviders.map((provider) => (
          ...
          >
            <div className={`flex-shrink-0 w-10 h-10 ${provider.color} rounded-lg flex items-center justify-center text-white group-hover:scale-105 transition-transform`}>
              {provider.icon}
            </div>
